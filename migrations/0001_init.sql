CREATE TABLE IF NOT EXISTS sources (
  ...
  icon TEXT,
  prefix TEXT,
  fetch_url_secret_ref TEXT,
  include_in_child_ics INTEGER NOT NULL DEFAULT 1,
  include_in_family_ics INTEGER NOT NULL DEFAULT 1,
  include_in_child_google_output INTEGER NOT NULL DEFAULT 1,
